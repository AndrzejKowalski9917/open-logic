...
- _FULL_: Exactly as descrived above
...
| MaxPackets_g       | positive  | 17      | Controls how many packets can be stored at maximum in the FIFO (i.e. controls the size of the packet-size FIFO).<br>Range: 2 ... 2^31-1 <br>**Not used for _FeatureSet_g=DROP_ONLY_**|
...
| Name         | In/Out | Length                       | Default | Description                                                  |
| :----------- | :----- | :--------------------------- | ------- | :----------------------------------------------------------- |
| PacketLevel  | out    | ceil(log2(_MaxPackets_g_+1)) | N/A     | Number of packets stored in the FIFO. The counter is incremented _after_ a packet was written completely and decremented _after_ the packet was read completely or skipped (due to _Out_Next_). <br>**Not used for _FeatureSet_g=DROP_ONLY_** |
